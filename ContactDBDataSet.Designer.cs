...
namespace Contacts {
    ...
    public partial class ContactDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PeopleRow AddPeopleRow(System.DateTime LastCall, string Name, bool Client, string email, string company, string telephone) {
...
namespace Contacts.ContactDBDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[People] WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_company = 1 AND [company] IS NULL) OR ([company] = @Original_company)) AND ((@IsNull_telephone = 1 AND [telephone] IS NULL) OR ([telephone] = @Original_telephone)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[People] ([LastCall], [Name], [Client], [email], [company], [telephone]) VALUES (@LastCall, @Name, @Client, @email, @company, @telephone);
SELECT ContactID, LastCall, Name, Client, email, company, telephone FROM People WHERE (ContactID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [LastCall] = @LastCall, [Name] = @Name, [Client] = @Client, [email] = @email, [company] = @company, [telephone] = @telephone WHERE (([ContactID] = @Original_ContactID) AND ((@IsNull_LastCall = 1 AND [LastCall] IS NULL) OR ([LastCall] = @Original_LastCall)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Client = 1 AND [Client] IS NULL) OR ([Client] = @Original_Client)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_company = 1 AND [company] IS NULL) OR ([company] = @Original_company)) AND ((@IsNull_telephone = 1 AND [telephone] IS NULL) OR ([telephone] = @Original_telephone)));
SELECT ContactID, LastCall, Name, Client, email, company, telephone FROM People WHERE (ContactID = @ContactID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, LastCall, Name, Client, email, company, telephone FROM dbo.Peop" +
                "le";
        ...
        public virtual int Delete(int Original_ContactID, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_email, string Original_company, string Original_telephone) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ContactID));
            if ((Original_LastCall.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((System.DateTime)(Original_LastCall.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> LastCall, string Name, global::System.Nullable<bool> Client, string email, string company, string telephone) {
            if ((LastCall.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(LastCall.Value));
            }
            else {
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> LastCall, string Name, global::System.Nullable<bool> Client, string email, string company, string telephone, int Original_ContactID, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_email, string Original_company, string Original_telephone, int ContactID) {
            if ((LastCall.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(LastCall.Value));
            }
            else {
            ...
            if ((Original_LastCall.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((System.DateTime)(Original_LastCall.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> LastCall, string Name, global::System.Nullable<bool> Client, string email, string company, string telephone, int Original_ContactID, global::System.Nullable<global::System.DateTime> Original_LastCall, string Original_Name, global::System.Nullable<bool> Original_Client, string Original_email, string Original_company, string Original_telephone) {
            return this.Update(LastCall, Name, Client, email, company, telephone, Original_ContactID, Original_LastCall, Original_Name, Original_Client, Original_email, Original_company, Original_telephone, Original_ContactID);
        }
    }
